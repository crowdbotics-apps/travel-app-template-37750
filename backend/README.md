...
## Project Structure
    ...
    ├── travel_app_template_37750  # Django project configurations
...
1. Clone this repo and `cd travel_app_template_37750`
...
2. Clone this repo and `cd travel_app_template_37750`
